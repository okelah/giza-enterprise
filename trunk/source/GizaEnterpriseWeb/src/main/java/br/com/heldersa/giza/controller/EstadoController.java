...
import br.com.heldersa.giza.facade.EstadoFacade;
...
public class EstadoController {
    ...
    @EJB private br.com.heldersa.giza.facade.EstadoFacade ejbFacade;
    ...
    public static class EstadoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Estado) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+EstadoController.class.getName());
            }
        }
